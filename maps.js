...
let Indiana=L.marker([39.849426, -86.258278]).addTo(myMap);
let Kentucky=L.marker([37.668140, -84.670067]).addTo(myMap);
let Louisiana=L.marker(31.169546, -91.867805]).addTo(myMap);
let Maine=L.marker(44.693947, -69.381927]).addTo(myMap);
